                ...
                <div class="radio-item">
                    <?php if($elType == 'radio'):?>
                        <input
                            ...
                            type="<?php echo $elType; ?>" name="single[<?= $element['element_order']; ?>][1]" id="q-<?php echo $element['element_order']  ?>-<?php echo $n; ?>" value="<?php echo $item ?>">
                    <?php else:?>
                        <input
                            data-related='<?= $related; ?>'
                            data-skip="<?= !empty($element['elements']['isSkipAll']) && !empty($element['elements']['skipItem']) && $element['elements']['skipItem'] == $n ?>"
                            type="<?php echo $elType; ?>" name="single[<?= $element['element_order']; ?>][<?= $n; ?>]>" id="q-<?php echo $element['element_order']  ?>-<?php echo $n; ?>" value="<?php echo $item ?>" data-reqired="reqired">
                    <?php endif;?>
